...
import CifFile
from types import *
#from math import sin,cos,pi,sqrt,pow,ceil,floori
from math import sin,cos,pi,sqrt,pow,ceil,floor,gcd
from utils import *
from spacegroupdata import *
from elementdata import *
from random import random, gauss
#from fractions import gcd # < python 3.7 
            ...
            for b in a:
                for k,v in b.species.items():
                    if k in self.ChemicalComposition:
                        ...
                        self.ChemicalComposition[k] = int(v+n)
                    else:
